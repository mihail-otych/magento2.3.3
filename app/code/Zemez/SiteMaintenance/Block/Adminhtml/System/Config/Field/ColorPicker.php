...
namespace Zemez\SiteMaintenance\Block\Adminhtml\System\Config\Field;
 ...
 *
 * @package Zemez\SiteMaintenance\Block\Adminhtml\System\Config\Field
 */
    ...
    protected function _getExtraCss()
    {
        return <<<EOL
            <style>
                .field-color-picker {
                    cursor: pointer;
                    background: url({$this->getViewFileUrl('Zemez_SiteMaintenance::images/colorpicker.png')})
                    no-repeat right;
                }
