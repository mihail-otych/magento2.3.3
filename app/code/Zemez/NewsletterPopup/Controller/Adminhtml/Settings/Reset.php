...
namespace Zemez\NewsletterPopup\Controller\Adminhtml\Settings;

use Zemez\NewsletterPopup\Model\ResourceModel\Config\Data as ConfigDataResource;
use Zemez\NewsletterPopup\Controller\Adminhtml\Settings;
 ...
 *
 * @package Zemez\NewsletterPopup\Controller\Adminhtml\Settings
 */
class Reset extends Settings
{
    ...
    {
        return $this->_authorization->isAllowed('Zemez_NewsletterPopup::newsletter_popup_reset');
    }
}