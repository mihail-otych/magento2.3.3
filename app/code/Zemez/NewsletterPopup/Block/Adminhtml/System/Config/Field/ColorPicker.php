...
namespace Zemez\NewsletterPopup\Block\Adminhtml\System\Config\Field;
 ...
 *
 * @package Zemez\NewsletterPopup\Block\Adminhtml\System\Config\Field
 */
    ...
    protected function _getExtraCss()
    {
        return <<<EOL
            <style>
                .field-color-picker {
                    cursor: pointer;
                    background: url({$this->getViewFileUrl('Zemez_NewsletterPopup::images/colorpicker.png')}) no-repeat right;
                }
