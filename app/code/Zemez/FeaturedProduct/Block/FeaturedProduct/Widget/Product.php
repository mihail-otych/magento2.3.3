        ...
        switch ($hoverType) {
            ...
            case ('gallery'):
                ...
                $result->setSlidesCount($this->getGallerySlidesCount())
                       ->setThumbnailSize(['width' => $this->getThumbWidth() ?? $result->getImageAttribute('product_thumbnail_image', 'width'), 'height' => $this->getThumbHeight() ?? $result->getImageAttribute('product_thumbnail_image', 'height')])
                       ->setSlideSize($imageSize);
                break;
            default: break;
        }
