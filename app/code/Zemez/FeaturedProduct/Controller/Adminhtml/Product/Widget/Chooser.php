...
namespace Zemez\FeaturedProduct\Controller\Adminhtml\Product\Widget;
...
class Chooser extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $productsGrid = $layout->createBlock(
            'Zemez\FeaturedProduct\Block\Adminhtml\Widget\Chooser',
            '',
            [
                'data' => [
                    'id' => $uniqId,
        ...
        if (!$this->getRequest()->getParam('products_grid')) {
            ...
            $html = $layout->createBlock('Zemez\FeaturedProduct\Block\Adminhtml\Widget\Chooser\Container')
