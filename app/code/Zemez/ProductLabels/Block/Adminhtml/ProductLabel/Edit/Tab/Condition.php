...
namespace Zemez\ProductLabels\Block\Adminhtml\ProductLabel\Edit\Tab;
...
class Condition extends Generic implements TabInterface
{
    ...
    protected function _prepareLayout()
    {
        \Magento\Framework\Data\Form::setFieldsetRenderer(
            $this->getLayout()->createBlock(
                'Zemez\ProductLabels\Block\Adminhtml\Renderer\FieldsetAccordion',
    ...
    {
        $model = $this->_coreRegistry->registry(\Zemez\ProductLabels\Api\Data\ProductLabelInterface::REGISTRY_NAME);
        //$model = $this->_coreRegistry->registry('current_promo_catalog_rule');
        /*
         * Checking if user have permissions to save information
         */
        if ($this->_isAllowedAction('Zemez_ProductLabels::productlabels_save')) {
        ...
        $renderer = $this->_rendererFieldset->setTemplate(
            'Zemez_ProductLabels::promo/fieldset.phtml'
        )->setNewChildUrl(
        ...
        $fieldsetDateRange->addField(
            'use_date_range', 'select',
            [
