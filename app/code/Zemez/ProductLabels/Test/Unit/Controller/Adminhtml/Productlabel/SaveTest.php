...
namespace Zemez\ProductLabels\Test\Unit\Controller\Adminhtml\Productlabel;
...
class SaveTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_saveAction =
            $this->_objectManager->getObject('Zemez\ProductLabels\Controller\Adminhtml\Productlabel\Save');
    }
