...
class Save extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Zemez_ProductLabels::productlabels_save');
    }
    ...
    public function execute()
    {
        ...
        try {
            ...
            return $resultRedirect->setPath(
                '*/*/edit', ['smart_label_id' => $this->getRequest()->getParam('smart_label_id')]
            );
        }
        ...
        if ($data) {
            ...
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath(
                        '*/*/edit', ['smart_label_id' => $model->getId(), '_current' => true]
                    );
                }
