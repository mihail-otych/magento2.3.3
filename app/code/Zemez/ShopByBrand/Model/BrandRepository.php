...
use Zemez\ShopByBrand\Model\ResourceModel\Brand as ResourceBrand;
...
class BrandRepository implements  BrandRepositoryInterface
{
     ...
     */
    public function save(\Zemez\ShopByBrand\Api\Data\BrandInterface $brand)
    {
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $brandModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                $brandData,
                $brandModel->getData(),
                'Zemez\ShopByBrand\Api\Data\BrandInterface'
            );
     ...
     */
    public function delete(\Zemez\ShopByBrand\Api\Data\BrandInterface $brand)
    {
        try {
