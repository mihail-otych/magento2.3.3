...
use Zemez\ShopByBrand\Api\Data;
use Zemez\ShopByBrand\Api\SoldBrandRepositoryInterface;
...
use Zemez\ShopByBrand\Model\ResourceModel\SoldBrand as ResourceSoldBrand;
use Zemez\ShopByBrand\Model\ResourceModel\SoldBrand\CollectionFactory as SoldBrandCollectionFactory;
...
class SoldBrandRepository implements  SoldBrandRepositoryInterface
{
     ...
     */
    public function save(\Zemez\ShopByBrand\Api\Data\SoldBrandInterface $soldBrand)
    {
        try {
    ...
    public function getList(\Magento\Framework\Api\SearchCriteriaInterface $criteria)
    {
        ...
        foreach ($collection as $soldBrandModel) {
            ...
            $this->dataObjectHelper->populateWithArray(
                ...
                'Zemez\ShopByBrand\Api\Data\SoldBrandInterface'
            );
     ...
     */
    public function delete(\Zemez\ShopByBrand\Api\Data\SoldBrandInterface $soldBrand)
    {
        try {
